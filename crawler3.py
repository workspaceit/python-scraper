...
with open('categories2.json') as json_data:
    ...
    for cat in categories:
        ...
        url2 = "https://api.gilt.com/v1/products?q=" + "Home" + "&store=home&apikey=8668a269aded3c5afe896fb815d3a6b31ee09b9b93b5c61ebd504171c9f8cdd2"
        ...
        for i in range(0, total_request):
            url2 = "https://api.gilt.com/v1/products?q=" + "Home" + "&store=home&apikey=8668a269aded3c5afe896fb815d3a6b31ee09b9b93b5c61ebd504171c9f8cdd2&start=" + str(start) + "&rows=" + str(rows)
            print(url2)
            url2 = url2.replace(" ", "%20")
            req2 = urllib2.Request(url2)
            res2 = urllib2.urlopen(req2)
